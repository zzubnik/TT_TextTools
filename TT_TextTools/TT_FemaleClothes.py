...
class TT_FemaleClothes:
    ...
    def load_options() -> List[str]:
        file_path = os.path.join(os.path.dirname(__file__), "FemaleClothes.txt")
...
# Register the node
NODE_CLASS_MAPPINGS["TT_FemaleClothes"] = TT_FemaleClothes
NODE_DISPLAY_NAME_MAPPINGS["TT_FemaleClothes"] = "TT Female Clothes"
